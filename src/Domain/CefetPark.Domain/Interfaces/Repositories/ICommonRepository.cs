...
namespace CefetPark.Domain.Interfaces.Repositories
{
    public interface ICommonRepository
    {
        ...
        public Task<bool> AdicionarEntidadesAsync<T>(List<T> entidades) where T : CommonEntity;
        ...
        public Task<ICollection<T>> ObterPorIdsAsync<T>(ICollection<int> ids) where T : CommonEntity;
