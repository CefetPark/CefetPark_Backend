...
namespace CefetPark.Application.Services
{
    public class DepartamentoService : IDepartamentoService
    {
        ...
        public DepartamentoService(ICommonRepository commonRepository, INotificador notificador, IMapper mapper)
        {
        ...
        {
            var entidade = await _commonRepository.ObterPorIdAsync<Departamento>(request.Id);
        ...
        {
            var entidade = _mapper.Map<Departamento>(request);
        ...
        {
            var entidade = await _commonRepository.ObterPorIdAsync<Departamento>(id);
        ...
        {
            var entidades = await _commonRepository.ObterTodosAsync<Departamento>();
